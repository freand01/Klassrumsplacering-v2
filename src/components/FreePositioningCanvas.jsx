...
const FreePositioningCanvas = ({ isDesignMode, currentBrush, desks = [], onDesksChange, lockedDesks = new Set(), onToggleLock, selectedDesk, onDeskSelect }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div ref={canvasRef} className="relative bg-white rounded-2xl shadow-xl border-2 border-gray-200 overflow-hidden print:shadow-none print:border print:rounded-none" style={{ height: '700px', width: '100%' }} onClick={handleCanvasClick}>
